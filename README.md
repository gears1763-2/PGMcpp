...
## Key Features
  ...
  * Any number of renewable resource time series can be modelled simultaneously (up to memory limitations), with resources being associated with chosen renewable production assets.
