...
testFloatEquals(
    test_interpolator.interp_map_1D[data_key].min_x,
    expected_x_vec[0],
    __FILE__,
    __LINE__
);
...
testFloatEquals(
    test_interpolator.interp_map_1D[data_key].max_x,
...
for (size_t i = 0; i < interp_x_vec.size(); i++) {
    testFloatEquals(
        test_interpolator.interp1D(data_key, interp_x_vec[i]),
...
testFloatEquals(
    test_interpolator.interp_map_2D[data_key].min_x,
    expected_x_vec[0],
    __FILE__,
    __LINE__
);
...
testFloatEquals(
    test_interpolator.interp_map_2D[data_key].max_x,
    expected_x_vec[expected_x_vec.size() - 1],
    __FILE__,
    __LINE__
);
...
testFloatEquals(
    test_interpolator.interp_map_2D[data_key].min_y,
    expected_y_vec[0],
    __FILE__,
    __LINE__
);
...
testFloatEquals(
    test_interpolator.interp_map_2D[data_key].max_y,
...
for (size_t i = 0; i < interp_y_vec.size(); i++) {
    for (size_t j = 0; j < interp_x_vec.size(); j++) {
        testFloatEquals(
            test_interpolator.interp2D(data_key, interp_x_vec[j], interp_y_vec[i]),
